...
import Thumb1 from '../../src/PaintingsAsset/RhythmOfEcstasy/1.png'
import Thumb2 from '../../src/PaintingsAsset/RhythmOfEcstasy/2.jpg'
import Thumb3 from '../../src/PaintingsAsset/RhythmOfEcstasy/3.jpg'
...
<li className="PaintingDetailList"><span className="ListLabel">Size:</span> <span className="ListValue">W- 91cm X 91cm</span></li>
...
<li className="PaintingDetailList"><span className="ListLabel">Year of Creation:</span> <span className="ListValue">2020</span></li>
