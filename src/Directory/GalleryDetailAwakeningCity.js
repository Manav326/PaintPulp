...
import Thumb1 from '../../src/PaintingsAsset/AwakeningCity/1.jpg'
import Thumb2 from '../../src/PaintingsAsset/AwakeningCity/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer>
       ...
       <h2 className="PaintingDetailTitle">The wooden house </h2>
