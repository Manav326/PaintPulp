...
import Thumb1 from '../../src/PaintingsAsset/SailingAway/1.jpg'
import Thumb2 from '../../src/PaintingsAsset/SailingAway/2.jpg'
...
<li className="PaintingDetailList"><span className="ListLabel">Size:</span> <span className="ListValue"> W- 101cm X 101cm</span></li>
