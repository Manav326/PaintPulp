...
import Thumb1 from '../../src/PaintingsAsset/TheLightMan/1.jpg'
import Thumb2 from '../../src/PaintingsAsset/TheLightMan/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer >
       ...
       <h2 className="PaintingDetailTitle">The light man </h2>
...
<li className="PaintingDetailList"><span className="ListLabel">Size:</span> <span className="ListValue">W- 40cm X 50cm</span></li>
