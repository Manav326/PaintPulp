...
import Thumb1 from '../OtherPaintings/BoatsOnARiver/1.jpg'
import Thumb2 from '../OtherPaintings/BoatsOnARiver/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer>
       ...
       <h2 className="PaintingDetailTitle"> Boats On A River</h2>
...
<li className="PaintingDetailList"><span className="ListLabel">Size:</span> <span className="ListValue">76cm X 100cm</span></li>
