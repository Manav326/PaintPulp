...
import Thumb1 from '../Bird/TheFalcon/1.jpg'
import Thumb2 from '../Bird/TheFalcon/2.jpg'
    ...
    return (
      <MainContainer>
       ...
       <div class="row justify-content-md-left" >
           <div class="col-xs-12  col-sm-7  col-lg-5" style={{padding:0}} >
