...
import Thumb1 from '../OtherPaintings/Rove/1.jpg'
import Thumb2 from '../OtherPaintings/Rove/2.jpg'
...
<li className="PaintingDetailList"><span className="ListLabel">Size:</span> <span className="ListValue">76cm X 76cm</span></li>
