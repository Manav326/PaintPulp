...
import Thumb1 from '../Flower/BloomWithGrace/1.jpg'
import Thumb2 from '../Flower/BloomWithGrace/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer>
       ...
       <h2 className="PaintingDetailTitle">Bloom with grace</h2>
