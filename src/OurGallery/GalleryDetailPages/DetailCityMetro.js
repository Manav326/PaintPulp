...
import Thumb1 from '../OtherPaintings/CityMetro/1.jpg'
import Thumb2 from '../OtherPaintings/CityMetro/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer>
       ...
       <h2 className="PaintingDetailTitle"> City Metro</h2>
...
<li className="PaintingDetailList"><span className="ListLabel">Medium:</span> <span className="ListValue">Canvas </span></li>
