...
import Thumb1 from '../Flower/OrangeDaisy/1.jpg'
import Thumb2 from '../Flower/OrangeDaisy/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer>
       ...
       <h2 className="PaintingDetailTitle">Orange Daisy</h2>
       <div className="PaintingDetailDesc">
       <p > Orange Daisy is a summer daisy windflower. Orange daisies represent happiness, joy, friendship and warmth. They are the most joyful type of daisies to send and receive! The perfect pick-me-up, you'll easily make someone's day with a bunch of bright orange daisies.
