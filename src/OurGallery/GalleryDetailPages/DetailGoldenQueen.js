...
import Thumb1 from '../Flower/GoldenQueen/1.jpg'
import Thumb2 from '../Flower/GoldenQueen/2.jpg'
  ...
  const GalleryDetailImages = [
    ...
    return (
      <MainContainer>
       ...
       <h2 className="PaintingDetailTitle">Golden Queen</h2>
       <div className="PaintingDetailDesc">
       <p > A striking and colorful element for the garden. 'Golden Queen' produces 2-3" wide, golden-orange, bowl-shaped flowers from late spring into midsummer. They stand in stark contrast against the dark green foliage.Golden Queen is a wonderful addition to any sunny or partially shaded, moist area such as the edges of ponds or streams.
